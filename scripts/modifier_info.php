...
$sql = "SELECT nom,prenom,adresse_1,adresse_2,ville,code_postal,pays,telephone,mail,identifiant,mot_de_passe FROM users WHERE identifiant = \"$client\"";
            ...
            <div id=\"container\">
                <form action=\"scripts/modification.php\" method=\"post\">
                    <table border=\"0\">
                        ...
                        <tr>
                            <td>Adresse:</td>
                            <td><input type=\"text\" name=\"Adresse_1\" value=\"$adresse1\"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>telephone:</td>
                            <td><input type=\"tel\" name=\"telephone\" value=\"$telephone\"></td>
                        </tr>
                        <tr>
                            <td>E-mail:</td>
                        ...
                        <tr>
                            <td>Identifiant:</td>
                            <td><input readonly=\"readonly\" type=\"text\" name=\"identifiant\" value=\"$identifiant\"></td>
                        </tr>

                        <tr>
                            <td>Mot de passe:</td>
                            <td><input type=\"password\" name=\"mot_de_passe\" value=\"$motdepasse\"></td>
                        </tr>
