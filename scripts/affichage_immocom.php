...
//nom
$sql = "SELECT nom,Adresse1,Ville,Code_postal,prix,Photo,id_bien FROM biens WHERE type_bien = \"Commercial\"";
$resultat = mysqli_query($sessionsql, $sql);

echo "
        <h2 class=\"titre\">Les Immobiliers commercial à vendre</h2>  
        <br>
    ";
    if (mysqli_num_rows($resultat) == 0) {
        echo '<center><p>Aucun bien commercial disponible.</p>';
    }
